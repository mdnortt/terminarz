...
class ContactController extends AbstractController
{
     ...
     * Constructor.
     *
     * @param ContactServiceInterface $eventService Event service
     * @param TranslatorInterface     $translator   Translator
     */
    public function __construct(ContactServiceInterface $eventService, TranslatorInterface $translator)
    {
